...
export const validateProfile = [
  ...
  body('diet_type').optional().isIn(['none', 'vegetarian', 'vegan', 'keto', 'mediterranean']).withMessage('Tipo de dieta invalido'),
  body('goal').optional().isIn(['lose_weight', 'gain_muscle', 'get_shredded']).withMessage('Objetivo invalido'),
  body('body_type').optional().isIn(['thin', 'average', 'heavy']).withMessage('Tipo de cuerpo invalido'),
