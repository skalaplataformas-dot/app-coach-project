...
// ─── SCHEDULE ENDPOINTS (MUST be before /:id to avoid conflict) ──────────

// GET /api/workouts/schedule/week
...
// GET /api/workouts/schedule/today
...
// PUT /api/workouts/schedule/:id/complete
...
// GET /api/workouts/:id (MUST be after /schedule/* routes)
